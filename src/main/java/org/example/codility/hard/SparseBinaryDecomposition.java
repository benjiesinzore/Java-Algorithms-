...
//LINK :: https://app.codility.com/demo/results/training49CD7P-9WC/
/*
...
public class SparseBinaryDecomposition {
    ...
    public int solution(int N) {
        ...
        // Return -1 if no sparse decomposition is found
        return -1;
    }

    private boolean isSparse(int x) {
        // A number is sparse if it does not contain consecutive bits set to 1
        return (x & (x >> 1)) == 0;
    }
}
